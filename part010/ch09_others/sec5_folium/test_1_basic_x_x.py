...
map3 = folium.raster_layers.WmsTileLayer(
    ...
    layers="landsat2000", transparent=True,
    fmt="image/png", name="Topo4", minZoom="10")

map_wms = folium.Map(location=[43.88, 125.35],
    zoom_start=12,  attr='My Data Attribution')
...
folium.Marker([43.8520, 125.3070],
    popup='长春南湖').add_to(map4)

folium.Marker([43.9980, 125.3960],
    popup='中科院东北地理所').add_to(map4)
